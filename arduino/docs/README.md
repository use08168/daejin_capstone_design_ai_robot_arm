...
![배선도 — Arduino Mega + PCA9685 + VL53L0X + 서보 7개 + SMPS 전원분배(콘덴서)·비상정지](../../docs/image/hardware-wiring.png)

> 위 배선도: 서보 전원은 SMPS에서 전원분배 보드(대용량 콘덴서로 순간 전류 완충)를 거쳐 공급, I2C(SDA/SCL)는 PCA9685·VL53L0X가 공유. 신호선만 PCA9685로 들어간다.
