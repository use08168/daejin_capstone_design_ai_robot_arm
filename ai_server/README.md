...
- 결과를 **gRPC + Protobuf**로 노트북에 전달 → [../docs/3_grpc_interface.md](../docs/3_grpc_interface.md)

> **현황(2026-06-14):** 음성 → Whisper STT → **Gemma 4 31B** → JSON DSL → 검증 **end-to-end 작동**(실제 마이크 음성 확인, 할루시네이션 방지 입증). gRPC·비전·RAG는 다음 단계.

자세히 → 설계 [docs/README.md](docs/README.md) · **구현 명세 [docs/1_implementation.md](docs/1_implementation.md)**
