...
브라우저 UI는 Django 웹앱(4페이지). 자세한 동작은 [docs/1_web_app.md](docs/1_web_app.md).
...
| [1_web_app.md](docs/1_web_app.md) | 4페이지 웹 UI + 엔드포인트 |
...
| [14_aruco_markers.md](docs/14_aruco_markers.md) | 로봇 마커 스킴 |
| [13_setup_procedure.md](docs/13_setup_procedure.md) | 초기 셋업 6단계 절차 |
