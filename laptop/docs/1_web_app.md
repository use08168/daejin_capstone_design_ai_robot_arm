...
5. **카메라→로봇 변환 T** — 골격
6. **관절 위치 & 작업공간** — 골격
- 절차 상세: [13_setup_procedure.md](13_setup_procedure.md), 파이프라인: [3_coordinate_3d_pipeline.md](3_coordinate_3d_pipeline.md)
...
**예정**
- **단계 ⑤⑥**: 베이스/추적 ArUco 마커로 카메라→로봇 변환 T, 관절 추적([14_aruco_markers.md](14_aruco_markers.md)).
