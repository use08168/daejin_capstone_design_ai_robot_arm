...
| J5 | `[−0.11,−0.99,0]` 준수직 | 손 수평 스윙 → 자기충돌 | 랜덤 |
| **J6** | `[−1,0,0]` 수평 피치 | **그리퍼를 바닥으로 내림** | 랜덤(바닥 핵심) |

> **발견:** 초기 스윕은 J6을 고정해, 정작 *그리퍼가 바닥에 닿는* 핵심 관절을 빠뜨렸다. J6을 넣자 충돌률이 6.5%→10.0%로 오르고, **손목 회전으로 그리퍼가 팔 본체(base·elbow)에 부딪히는 자기충돌(1.7%)** 이 처음 드러났다.
