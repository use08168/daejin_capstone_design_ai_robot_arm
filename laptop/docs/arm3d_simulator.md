...
디지털 트윈을 **안전 사전검증**에 쓰는 기능을 제어 모드에 내장했다. 원리·결과·그림은 **[digital_twin_safety.md](digital_twin_safety.md)** 에 상세히 있고, 여기서는 시뮬레이터 UI만 정리한다.
...
- **안전 마진**은 콜드스타트로 측정한 **sim-real gap(30mm)** 에 연동 → "시뮬 안전 ⇒ 실물 안전" 보증. ([coldstart_procedure.md](coldstart_procedure.md))
