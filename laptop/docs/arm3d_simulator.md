...
> 📷 **사진 자리:** 참조 로봇팔 설계도 — `docs/image/reference-design.jpg` (추가 예정)
> 📷 **사진 자리:** 실물 조립 완료 사진 — `docs/image/real-arm.jpg`
...
> 📷 **사진 자리:** 결합 중 원통/평면 선택 화면 — `docs/image/sim-face-mate.jpg`
> 📷 **사진 자리:** 6관절 조립 완료 + 고정 연결선 — `docs/image/sim-assembled.jpg`
